          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                ...
                <a class="nav-link" href="${pageContext.request.contextPath}/logout">${customInfo.name}님, [로그아웃]</a>
         		</li></c:if>
         		
         		 <c:if test="${!userLoggedIn}">
              <li class="nav-item">
             
                <a class="nav-link" href="${pageContext.request.contextPath}/log">로그인</a>
         		</li></c:if>
...
<c:choose>
	<c:when test="${sessionScope.customInfo != null && sessionScope.customInfo.name ==msg.writer}" >
